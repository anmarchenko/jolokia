...
# copy changed site
grep -lr 2.5.2-SNAPSHOT | xargs sed -i 's/2.5.2-SNAPSHOT/2.5.1/g'
git add .
...
6. `mvn -Dmaven.repo.local=/tmp/repo -DdevelopmentVersion=2.5.2-SNAPSHOT -DreleaseVersion=2.5.1 -Dtag=v2.5.1 -Pdist release:prepare`
